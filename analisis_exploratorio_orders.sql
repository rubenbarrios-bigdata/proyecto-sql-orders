...
-- 1. Validación inicial de los datos
-- Objetivo:
-- Verificar que la tabla fue importada correctamente
-- y visualizar los primeros 5 registros.
-- -----------------------------------------------------
...
-- =====================================================
-- Objetivo:
-- Verificar que el dataset no presente valores nulos,
-- registros inconsistentes o posibles errores antes
...
-- -----------------------------------------------------
-- Objetivo:
-- Identificar si existen valores faltantes en columnas clave.
-- -----------------------------------------------------
...
-- Interpretación:
-- Esta consulta permite confirmar si existen o no valores faltantes
...
-- -----------------------------------------------------
-- Objetivo:
-- Detectar órdenes repetidas que puedan afectar el análisis.
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Objetivo:
-- Identificar posibles valores atípicos o pérdidas.
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Objetivo:
-- Determinar cuántos registros presentan ganancias negativas
-- para dimensionar el impacto finaciero. 
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Objetivo:
-- Calcular el porcentaje de registros que presentan
-- ganancias negativas para dimensionar su impacto
-- dentro del total de operaciones.
-- -----------------------------------------------------
...
-- 3. Cantidad total de registros
-- Objetivo:
-- Confirmar el número total de transacciones registradas.
-- -----------------------------------------------------
...
-- 4. Ventas totales
-- Objetivo:
-- Calcular el total de ingresos generados en el período.
-- -----------------------------------------------------
...
-- 5. Ventas por categoría
-- Objetivo:
-- Identificar qué categoría de productos genera
-- mayores ingresos.
-- -----------------------------------------------------
...
-- 6. Ventas por región
-- Objetivo:
-- Analizar el desempeño comercial por ubicación geográfica.
-- -----------------------------------------------------
...
-- 7. Top 10 clientes por volumen de compra
-- Objetivo:
-- Identificar los clientes que más ingresos generan.
-- -----------------------------------------------------
...
-- 8. Rentabilidad por categoría
-- Objetivo:
-- Comparar ventas totales con ganancia obtenida.
-- -----------------------------------------------------
